...
ggplot(phases, aes(date)) + geom_line(aes(y = open, color = "open fixing")) +
  ...
  labs(title = "Rozkład transakcji w zależności od fazy - wykres ciągły", x = "Dane", y = "Procentowy udział transakcji")
```
...
ggboxplot(phases2, x = "phase", y = "amount", color = "phase", palette = "npg") + labs(title="Rozkład transakcji w zależności od fazy - wykres pudełkowy", x="Faza", y="Udział procentowy")
...
ggplot(outputData) + geom_point(aes(x = minutes, y = aggregatedData/10000)) + labs(title="Wystąpienia transakcji w czasie", x="Czas", y="Liczba transakcji w jednej minucie[10^4]")
```
